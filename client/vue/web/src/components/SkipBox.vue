<template>
    <div>
        <div class="card">
            ...
            <span class="tip"><strong>Are you sure to submit ?</strong></span>
            <div class="itemBar">
                <span class="itemBtn leftBtn" @click="setLock(false)">
                    Cancel
                </span>
                <span :class="{
...
export default {
    name: "SkipBox",
    computed: {
        ...mapState('skipbox', ['iconName', 'closeActive', 'confirmActive', 'hover'])
    },
    methods: {
