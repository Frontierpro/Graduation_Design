import scrapy
from reading.items import TMPItem
...
class TMP(scrapy.Spider):
    ...
    start_urls = [
        'https://liuxue.koolearn.com/toefl/read/',
        'https://top.zhan.com/toefl/read/alltpo.html',
        'https://toefl.kmf.com/read/ets/new-order/0'
    ]
