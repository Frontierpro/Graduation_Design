import scrapy
from speaking.items import TMPItem
...
class TMP(scrapy.Spider):
    ...
    start_urls = [
        'https://liuxue.koolearn.com/toefl/speak/',
        'https://top.zhan.com/toefl/speak/alltpo.html',
        'https://toefl.kmf.com/speak/ets/new-order/0'
    ]
    ...
    def parse(self, response):
        ...
        zhan_filter = "//ul[@class='cssTopTitleList clearfix']//a/@href"
